    ...
    useEffect(() => {
        ...
        const fetchService = async () => {
            ...
            try {
                ...
                if (!fetchedService) {
                    toast({ title: "Not Found", description: "Service could not be found.", variant: "destructive" });
                    router.push('/dashboard/services');
                    return;
                }
                if (fetchedService.freelancerId !== user.uid) {
        ...
        <div className="container mx-auto px-4 py-8">
            <Card className="max-w-3xl mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>Update the details for your service.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
